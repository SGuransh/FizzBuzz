# CSC207 Week 1 Lab Activity #1: Fizz Buzz (This is the main change that I made)
...
- The for loop takes in variable with, condition and step which is pretty much the while loop.
- if statements have the conditions in the brackets
- The curly brackets and the semi colons
